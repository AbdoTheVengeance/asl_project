...
class PhaseEvaluator:
    ...
    def _get_model_dir(self, model_name: str) -> Path:
        """Get or create directory for specific model results"""
    ...
    def _save_detailed_report(self, model_name: str, phase: int, report: Dict) -> None:
        ...
        report_path = model_dir / f'{model_name}_phase{phase}_detailed_report.json'
    ...
    def plot_confusion_matrix(self, model_name: str, phase: int, figsize: Tuple[int, int] = (16, 12)) -> Optional[Path]:
        ...
        cm_path = model_dir / f'{model_name}_phase{phase}_confusion_matrix.png'
        ...
        cm_counts_path = model_dir / f'{model_name}_phase{phase}_confusion_matrix_counts.png'
